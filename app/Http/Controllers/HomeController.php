...
class HomeController extends Controller
{
    ...
    // Room Review
    public function roomReviewIndex(){
        $reviews=RoomReview::getAllUserReview();
        return view('user.review.index')->with('reviews',$reviews);
    }

    public function roomReviewEdit($id)
    {
     ...
     */
    public function roomReviewUpdate(Request $request, $id)
    {
        $review=RoomReview::find($id);
        if($review){
            $data=$request->all();
        ...
        return redirect()->route('user.roomreview.index');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function roomReviewDelete($id)
    {
        $review=RoomReview::find($id);
