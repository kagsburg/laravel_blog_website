              ...
              <div class="card">
                  ...
                  <div class="card-body card-block">
                    <form method="post" action="{{route('banner.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="inputTitle" class="col-form-label">{{ __('sidebar.bann_button') }} <span class="text-danger">*</span></label>
                      <input id="inputTitle" type="text" name="button" placeholder=""  value="{{old('button')}}" class="form-control">
                      @error('button')
                      <span class="text-danger">{{$message}}</span>
                      @enderror
                      </div>
                      ...
                      <div class="form-group">
                        <label for="inputTitle" class="col-form-label">{{ __('sidebar.bann_link') }} <span class="text-danger">*</span></label>
                      ...
                      <div class="form-group">
                        <label for="inputDesc" class="col-form-label">{{ __('sidebar.bann_desc') }}</label>
                      ...
                      <div class="form-group mb-3">
                        <button type="reset" class="btn btn-warning">{{ __('sidebar.b_reset') }}</button>
                        <button class="btn btn-success" type="submit">{{ __('sidebar.b_submit') }}</button>
                      </div>
                    </form>
                  </div>
              </div>
