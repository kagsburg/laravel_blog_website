                          ...
                          <tr class="tr-shadow">
                              ...
                              <td>
                                  <div class="table-data-feature">
                                      <a href="{{route('banner.edit',$banner->id)}}" class="item" data-toggle="tooltip" data-placement="top" title="Edit" 
                                        style="height:30px; width:30px;border-radius:50%"><i class="zmdi zmdi-edit"></i></a>
                                      <form method="POST" action="{{route('banner.destroy',[$banner->id])}}">
                                        @csrf 
                                        @method('delete')
                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Delete" data-id={{$banner->id}} 
