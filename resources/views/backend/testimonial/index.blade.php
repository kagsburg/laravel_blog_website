...
@section('title') {{ __('sidebar.testimony_title_name') }} @endsection
  ...
  <div class="section__content section__content--p30">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
              <!-- DATA TABLE -->
              <h3 class="title-5 m-b-35">{{ __('sidebar.testimony_title_name') }}</h3>
              <div class="table-data__tool">
                  ...
                  <div class="table-data__tool-right">
                      <a href="{{route('testimonial.create')}}" class="au-btn au-btn-icon au-btn--green au-btn--small"><i class="zmdi zmdi-plus"></i>{{ __('sidebar.add_testimony') }}</a>
                  </div>
              </div>
              <div class="table-responsive table-responsive-data2">
                ...
                @else
                  <h6 class="text-center">No testimonial found!!! Please create testimony</h6>
                @endif
              </div>
              <!-- END DATA TABLE -->
          </div>
